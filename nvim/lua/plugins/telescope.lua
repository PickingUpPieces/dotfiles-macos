return {
    {
        ...
        keys = {
            ...
            { "<leader>fg", mode = { "n" }, function() require("telescope.builtin").git_files() end, desc = 'Telescope: find only git registered files' },
            { "<leader>fs", mode = { "n" }, function() require("telescope.builtin").live_grep() end, desc = 'Telescope: find string' },
        }
    },
    {
